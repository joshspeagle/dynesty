...
``dynesty`` is compatible with Python 3.8+. It requires
...
Returns the following list of papers that should be cited::
    ...
    Koposov et al. (2026): https://doi.org/10.5281/zenodo.3348367
...
If you see any regressions in 3.0, please report them
